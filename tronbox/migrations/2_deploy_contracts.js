...
const PaykikArtifacts = artifacts.require("PaykikTest");
...
async function SwapDeploy(deployer) {
    ...
    // await deployer.deploy(SwapArtifacts, usdtAddr, paykikAddr, paykikAddr, paykikAddr, { gas: 2000000 }); // todo remove tests
